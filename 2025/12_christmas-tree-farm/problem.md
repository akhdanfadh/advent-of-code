...
In fact, many of these new arrivals look *familiar*: they're the Elves you helped while decorating the North Pole base. Right on [schedule](https://adventofcode.com/2025/day/1), each group seems to have brought a *star* to put atop one of the Christmas trees!
...
At this point, all that is left is for you to [admire your Advent calendar](https://adventofcode.com/2025).
